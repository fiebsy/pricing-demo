/**
 * StackingNav Motion V2 Playground
 *
 * V2 implementation with centralized phase state machine.
 * Uses single phase coordinator instead of 4 independent hooks.
 *
 * @module playground/stacking-nav-motion-v2
 */
...
export default function StackingNavMotionV2Playground() {
  ...
  const handleControlChange = useCallback((event: ControlChangeEvent) => {
    ...
    const nonPresetFields = [
      ...
      'showNumbers',
      'showDebug',
      'showPhaseIndicator', // V2-specific
      'pageBackground',
      'showLevelAll',
      'levelAllLabel',
