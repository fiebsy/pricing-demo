/**
 * Question Command Menu V3 - Questions Content
 *
...
import { useV3Context, useFilteredQuestions } from '../core'
import type { QuestionItem, QuestionGroup, QuestionsConfig, SlotPosition } from '../config/types'
...
// Strings
import { STATUS_CONFIG } from '../strings'
...
export const QuestionsContent: React.FC<QuestionsContentProps> = ({
  ...
  const filteredGroups = useFilteredQuestions(groups)
