/**
 * Question Command Menu V4 - Button Options
 *
...
export const BUTTON_SHOW_WHEN_OPTIONS = [
  ...
  { label: 'Only When Editing', value: 'editing' },
  { label: 'Only When Has Value', value: 'has-value' },
  { label: 'Only After Save', value: 'saved' },
  { label: 'Only Before Save', value: 'not-saved' },
] as const
