/**
 * Question Command Menu V4 - Default Preset
 *
 * Base configuration that all other presets extend from.
 */

import type { QuestionCommandMenuV4Config, QuestionCommandMenuV4Preset } from '../types'
import { COMMON_BUTTONS } from './helpers'

// =============================================================================
// DEFAULT CONFIG
// =============================================================================

export const DEFAULT_CONFIG: QuestionCommandMenuV4Config = {
  animation: {
    duration: 350,
...
export const DEFAULT_PRESET: QuestionCommandMenuV4Preset = {
  id: 'default',
  name: 'Default',
  category: 'default',
