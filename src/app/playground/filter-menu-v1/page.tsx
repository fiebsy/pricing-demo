/**
 * Filter Menu V1 Playground (Legacy)
 *
 * This is the pre-date-picker version of the filter menu playground,
 * preserved from commit 35c9f4c (Feb 19, 2026) for comparison purposes.
 *
 ...
 *
 * Note: This version does NOT have:
 * - Date picker variant
 * - Variant switching
...
export default function FilterMenuV1Playground() {
      ...
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="text-center">
          <h1 className="text-display-sm font-display text-primary">
            Filter Menu <span className="text-tertiary">(Legacy V1)</span>
          </h1>
          <p className="text-secondary mt-2 text-sm">
            Pre-date-picker version from Feb 19, 2026
