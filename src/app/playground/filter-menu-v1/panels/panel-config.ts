/**
 * Filter Menu V1 Control Panel Configuration (Legacy)
 *
 * This is the pre-date-picker panel config preserved from commit 35c9f4c.
 *
 * Key differences from current version:
 * - NO variant selector section
 * - NO date picker section
 * - HAS unified hover section (basic controls)
