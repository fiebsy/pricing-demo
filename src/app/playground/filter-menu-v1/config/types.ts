/**
 * Filter Menu V1 Configuration Types (Legacy)
 *
 * This is the pre-date-picker type system preserved from commit 35c9f4c.
 *
 ...
 * - items is required (not optional)
 *
 * @status legacy
 * @source-commit 35c9f4c
 */
...
export interface FilterMenuConfig {
  ...
  menu: MenuConfig
  /** V1: items is required (not optional like in V2) */
