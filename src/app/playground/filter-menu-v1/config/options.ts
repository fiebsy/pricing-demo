/**
 * Filter Menu V1 Control Panel Options (Legacy)
 *
 * This is the pre-date-picker options preserved from commit 35c9f4c.
 *
 * Key differences from current version:
 * - NO VARIANT_OPTIONS (no variant switching)
 * - HAS unified hover options
 *
