/**
 * Filter Menu V1 Preview Component (Legacy)
 *
 * This is the pre-date-picker version preserved from commit 35c9f4c.
 * It only supports the table-filter variant (no date picker).
 *
