...
export const LANDING_HERO_PRESETS: LandingHeroPresetMeta[] = [
  ...
  },
  {
    ...
    name: 'Minimal',
    category: 'minimal',
    description: 'No pattern, no blur circle, subtle shadow',
    data: {
      background: {
        showPattern: false,
        patternType: 'none',
  ...
  },
  {
    ...
    name: 'Dramatic',
    category: 'dramatic',
    description: 'Large blur circle, intense shine, heavy shadow',
    data: {
      background: {
        showPattern: true,
        patternType: 'dots',
  ...
  },
  {
    ...
    name: 'Brand Focus',
    category: 'brand',
    description: 'Brand colors, pattern overlay, medium blur',
    data: {
      background: {
        showPattern: true,
        patternType: 'grid',
