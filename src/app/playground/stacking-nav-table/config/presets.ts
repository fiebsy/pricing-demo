...
export const PRESET_DEFAULT: PlaygroundConfig = {
  ...
  badgeShape: 'squircle',
  badgeNeutral: true,
  originAvatarWidth: 24,
  originAvatarHeight: 28,
  ...
  barBaselineStatusColor: 'neutral-dark',
  navVariant: 'default',
  showNavDebug: false,
}
