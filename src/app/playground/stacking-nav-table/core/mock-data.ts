    ...
    departments: [
      {
        ...
        label: 'Engineering',
        teams: [
          { id: 'acme-eng-fe', label: 'Frontend', roles: ['Frontend', 'UI Eng', 'React Dev'] },
          { id: 'acme-eng-be', label: 'Backend', roles: ['Backend', 'API Dev', 'Systems'] },
          { id: 'acme-eng-devops', label: 'DevOps', roles: ['DevOps', 'SRE', 'Cloud'] },
        ],
      },
      {
        id: 'acme-design',
        label: 'Design',
        teams: [
          { id: 'acme-design-product', label: 'Product Design', roles: ['Product', 'UX', 'IxD'] },
          { id: 'acme-design-brand', label: 'Brand Design', roles: ['Brand', 'Visual', 'Creative'] },
        ],
      },
      {
        id: 'acme-sales',
        label: 'Sales',
        teams: [
          { id: 'acme-sales-ent', label: 'Enterprise Sales', roles: ['AE', 'Solutions', 'Director'] },
          { id: 'acme-sales-smb', label: 'SMB Sales', roles: ['AE', 'SDR', 'Manager'] },
        ],
      },
      {
        id: 'acme-ops',
        label: 'Operations',
        teams: [
          { id: 'acme-ops-hr', label: 'Human Resources', roles: ['HR', 'Recruiter', 'People'] },
          { id: 'acme-ops-finance', label: 'Finance', roles: ['Analyst', 'Controller', 'Acct'] },
        ],
      },
    ],
  },
    ...
    departments: [
      {
        ...
        label: 'Engineering',
        teams: [
          { id: 'globex-eng-platform', label: 'Platform', roles: ['Platform', 'Infra', 'Build'] },
          { id: 'globex-eng-mobile', label: 'Mobile', roles: ['iOS', 'Android', 'Mobile'] },
          { id: 'globex-eng-data', label: 'Data Engineering', roles: ['Data', 'ML', 'Analytics'] },
        ],
      },
      {
        id: 'globex-product',
        label: 'Product',
        teams: [
          { id: 'globex-product-growth', label: 'Growth', roles: ['Growth', 'Analyst', 'Exp Lead'] },
          { id: 'globex-product-core', label: 'Core Product', roles: ['Sr PM', 'PM', 'Tech PM'] },
        ],
      },
      {
        id: 'globex-mktg',
        label: 'Marketing',
        teams: [
          { id: 'globex-mktg-content', label: 'Content Marketing', roles: ['Content', 'Copy', 'Editor'] },
          { id: 'globex-mktg-demand', label: 'Demand Gen', roles: ['Demand', 'Campaign', 'Mkt Ops'] },
        ],
      },
    ],
  },
    ...
    departments: [
      {
        ...
        label: 'Engineering',
        teams: [
          { id: 'initech-eng-infra', label: 'Infrastructure', roles: ['Infra', 'Network', 'SysAdmin'] },
          { id: 'initech-eng-security', label: 'Security', roles: ['SecEng', 'PenTest', 'Analyst'] },
          { id: 'initech-eng-qa', label: 'QA', roles: ['QA', 'Automation', 'QA Lead'] },
        ],
      },
      {
        id: 'initech-support',
        label: 'Support',
        teams: [
          { id: 'initech-support-tier1', label: 'Tier 1 Support', roles: ['Support', 'CS', 'Help Desk'] },
          { id: 'initech-support-tier2', label: 'Tier 2 Support', roles: ['Sr Support', 'Tech Sup', 'Escalation'] },
        ],
      },
      {
        id: 'initech-legal',
        label: 'Legal',
        teams: [
          { id: 'initech-legal-contracts', label: 'Contracts', roles: ['Contracts', 'Counsel', 'Paralegal'] },
          { id: 'initech-legal-compliance', label: 'Compliance', roles: ['Compliance', 'Risk', 'Audit'] },
        ],
      },
    ],
  },
