 ...
 */
export function ViewProfileContent({ data, onEdit }: ViewProfileContentProps) {
  ...
  return (
    <div className="relative z-10">
      ...
      >
        <div
          ...
          style={{
            ...
            boxShadow: 'var(--profile-shadow-image, 0 4px 12px rgba(0,0,0,0.1))',
          }}
        >
      ...
      {/* Name */}
      <h1
        className="mt-6 mb-3 -ml-0.5 font-semibold leading-[1.1] text-[var(--color-gray-900)] animate-in fade-in slide-in-from-bottom-4"
        style={{
      ...
      <div
        className="flex items-center gap-2 pb-5 text-md text-[var(--color-gray-600)] animate-in fade-in slide-in-from-bottom-4"
        style={{
      ...
      >
        ...
        {data.organization.name && (
          <>
            <span className="text-[var(--color-gray-400)]">at</span>
      ...
      {data.questions.length > 0 && (
        <div
          className="-ml-5.5 -mr-5.5 mb-8 rounded-none bg-[var(--color-gray-900)]/5 p-6 pb-2 md:rounded-[30px] animate-in fade-in slide-in-from-bottom-4"
          style={{
        ...
        >
          ...
          <div className="flex w-full items-center justify-between pb-4">
            <h2 className="relative w-full text-xl font-[580] text-[var(--color-gray-900)]">
          ...
          <div className="flex flex-col gap-2">
            {data.questions.map((question, index) => (
              <button
                ...
                type="button"
                className={cn(
                  'w-fit cursor-pointer rounded-[20px] bg-[var(--color-gray-900)]/5 px-4 py-3',
                  'text-left text-[var(--color-gray-900)]',
      ...
      {data.socialLinks.length > 0 && (
        ...
        >
          <h2 className="pb-4 text-md text-[var(--color-gray-900)]/60">
            ...
            {data.socialLinks.map((link, index) => {
              ...
              return (
                <a
                  ...
                  className={cn(
                    'rounded-2xl bg-[var(--color-gray-900)]/5 p-1.5',
                    'text-[var(--color-gray-900)]/70',
                    'hover:bg-[var(--color-gray-900)]/10',
                    'hover:text-[var(--color-gray-900)]',
                    'transition-colors'
                  )}
      ...
      {/* Footer */}
      <footer className="w-fit pb-4 pt-[25px] text-left text-xs text-[var(--color-gray-900)]/70">
        <p>
          © 2026 Delphi ·{' '}
          <a
            href="/terms-of-use"
            target="_blank"
            rel="noopener noreferrer"
            className="transition-colors hover:text-[var(--color-gray-900)]"
          >
            Terms
          </a>{' '}
          ·{' '}
