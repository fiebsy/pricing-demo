...
// V3 Components
import { ProfileV3Layout } from './profile-v3/components/layout'
import { Scorecard } from './profile-v3/components/scorecard'
import { AvatarVideo } from './profile-v3/components/video'
import { EditableProfilePanel } from './profile-v3/components/editable-profile'

// Quick Fix Modal
import { QuickFixModal } from '@/app/playground/quick-fix-modal/core/QuickFixModal'
import { PROFILE_QUICK_FIX_CONFIG, PROFILE_INTEGRATION_CONFIG } from './profile-v3/config/quick-fix-config'
...
import type { ChatOverlayRef } from './profile/components/chat'

// V3 Question components (command menu based)
import { QuestionsContainer, QuestionCard, AddQuestionInput } from './profile-v3/components/questions'
...
// Auth components
import { useAuth } from './profile/hooks/useAuth'
...
import {
  ...
  useEditMode,
  useQuestions,
} from './profile-v3/hooks'

// Constants
import { MOCK_PROFILE } from './profile-v3/constants'

// Types
import type { ProfileQuestion, CategoryType, ScoreImprovement } from './profile-v3/types'
import type { ChatMessage } from './profile/types'
...
function BPageContent() {
  ...
  return (
    <>
      ...
      {/* Logout button - bottom right, only when authenticated */}
      {isAuthenticated && (
