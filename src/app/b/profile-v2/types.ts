...
import type { CategoryType, ProfileQuestion, SectionType } from '../profile/types'
...
export interface EditPanelProps {
  scores: import('../profile/types').ProfileScores
...
export interface CategoryMetricsProps {
  categories: import('../profile/types').CategoryScoreData[]
  expandedCategory: CategoryType | null
  onCategoryToggle: (category: CategoryType) => void
