            ...
            controls: [
              {
                id: 'showContentGrid',
                type: 'toggle',
                label: 'Show Content Grid',
                value: config.showContentGrid,
              },
            ],
          },
          {
          ...
          },
          {
            ...
            controls: [
              ...
              },
              {
                ...
                type: 'slider',
                label: 'Padding Right',
                value: config.containerPaddingRight,
                min: 0,
                max: 40,
                step: 4,
                formatLabel: (v: number) => (v === 0 ? '0' : `${v}px`),
              },
              {
                ...
                value: config.containerPaddingBottom,
                min: 0,
                max: 40,
                step: 4,
                formatLabel: (v: number) => (v === 0 ? '0' : `${v}px`),
              },
              {
                ...
                type: 'slider',
                label: 'Padding Left',
                value: config.containerPaddingLeft,
                min: 0,
                max: 40,
                step: 4,
                formatLabel: (v: number) => (v === 0 ? '0' : `${v}px`),
              },
              {
                id: 'navMinHeight',
                type: 'slider',
                label: 'Nav Min Height',
                value: config.navMinHeight,
                min: 0,
                max: 200,
                step: 10,
