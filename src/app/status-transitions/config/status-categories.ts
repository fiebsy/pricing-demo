...
const AT_RISK_STATUSES = [
  // Low Risk - Non-standard payment arrangements
...
const OTHER_ACTIVE_STATUSES = [
  // Deprecated/Transitory statuses
  'MANUAL_REVIEW',
  'IN_UNDERWRITING',
...
const CLAWED_BACK_STATUSES = [
  ...
  // Moved from AT_RISK to align with backend LOST_PENDING_STATUSES
