...
import { CloseIcon } from '../assets/inline-icons'
...
import { CoinStack, getPresetById } from '../assets/coin-stack'
import {
...
interface PricingModalProps {
  ...
  onBackClick: () => void
  /** Force dropdown expanded for capture mode */
    ...
    if (sectionConfig.type === 'pricing-select') {
      return (
        <PricingSelectSlot
          ...
          forceExpanded={forceDropdownExpanded}
        />
      )
    }
