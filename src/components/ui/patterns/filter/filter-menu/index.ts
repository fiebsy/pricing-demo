 ...
 * @example Basic Usage
 * ```tsx
 * import { FilterMenu } from '@/components/ui/patterns/filter/filter-menu'
 *
 * <FilterMenu
 *   items={filterItems}
...
export { MenuItemComponent, MenuBackButton } from '@/components/ui/core/primitives/menu'
...
export type {
  ...
  IconType,
  PanelState,
} from '@/components/ui/core/primitives/menu'
