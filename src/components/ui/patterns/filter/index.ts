...
// Note: RevealMode renamed to FilterChipRevealMode to avoid conflict with features/expanding-search
export type {
  FilterChipProps,
  ChipConfig,
  ChipSize,
  ChipRounded,
  RevealMode as FilterChipRevealMode,
} from './filter-chip'
...
// Note: Menu types should be imported directly from '@/components/ui/core'
