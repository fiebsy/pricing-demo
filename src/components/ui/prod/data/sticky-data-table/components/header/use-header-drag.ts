...
interface UseHeaderDragOptions {
  ...
  /**
   * Threshold for triggering column swap in inline mode.
   * Value between 0 and 1 representing percentage of column width.
   * Lower = more sensitive (triggers swap sooner).
   * @default 0.5 (50% - triggers when dragged column center passes target midpoint)
   * @example 0.35 = triggers at 35% of column width (more sensitive for wide columns)
   */
