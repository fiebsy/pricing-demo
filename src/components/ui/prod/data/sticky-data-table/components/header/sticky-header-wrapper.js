...
const navigation_arrows_1 = require("../navigation/navigation-arrows");
const table_header_1 = require("./table-header");
const drag_column_overlay_1 = require("./drag-column-overlay");
/**
...
dragState, columnRectsRef, dragStartXRef, isColumnDraggable, handlePointerDown, handlePointerMove, handlePointerUp, handlePointerCancel, getShiftDirection, getInlineOffset, getShiftAmount, cloneMode, isInlineDragMode, gradientBackgroundColor = 'var(--background-color-secondary_alt)', hideArrows = false, }) => {
    ...
    showScrollIndicator={showScrollIndicator} gradientBackgroundColor={gradientBackgroundColor}/>
      ...
      {isInlineDragMode && dragState && columnRectsRef && dragStartXRef && (<drag_column_overlay_1.DragColumnOverlay dragState={dragState} columnRectsRef={columnRectsRef} dragStartXRef={dragStartXRef} bodyScrollRef={bodyScrollRef} borderRadius={borderRadius}/>)}
    </div>);
};
