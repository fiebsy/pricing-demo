...
exports.DEFAULT_TABLE_CONFIGURATION = void 0;
...
exports.DEFAULT_TABLE_CONFIGURATION = {
    ...
    dimensions: {
        ...
        headerHeight: 42,
        borderRadius: 16,
        headerGap: constants_1.TABLE_CONFIG.HEADER_GAP,
    },
    // -------------------------------------------------------------------------
    // BORDER (JAN2)
    // -------------------------------------------------------------------------
    ...
    toolbar: {
        ...
        bottomMargin: constants_1.TABLE_CONFIG.TOOLBAR_MARGIN,
        countGap: 0,
        integratedHeight: 32,
        integratedPadding: {
            top: 0,
