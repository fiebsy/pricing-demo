/**
 * Biaxial Command Menu V4 - Type Definitions
 *
 * Composable slot-based architecture with flexible content areas.
 * Designed for maximum flexibility while maintaining the beautiful
 * biaxial animation system from V3.
 */
...
/**
 * Complete configuration for BiaxialExpandV4.
 */
...
/**
 * Context value provided by BiaxialExpandV4.Root.
 */
...
// ============================================================================
// COMMAND ITEM TYPES (shared with V3)
// ============================================================================
