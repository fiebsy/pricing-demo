/**
 * Biaxial Expand - Helper Utilities
 *
 * Common utility functions for styling and calculations.
 */

import type { BackgroundOption, BorderColorOption, CommandGroup } from '../types'
