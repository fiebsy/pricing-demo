...
import { GradientOverlay, StickyHeaderWrapper, TableBody, ToolbarContent } from './components'
import { useHeaderDrag } from './components/table-header/use-header-drag'
import { calculateIntegratedHeaderGap, TABLE_CONFIG } from './config'
import { useStickyDataTable } from './hooks'
        ...
        <div className="relative">
          <div className="relative">
            ...
            <StickyHeaderWrapper
              ...
              hideArrows={sortedData.length === 0 && !isLoading}
            ...
            {sortedData.length === 0 && !isLoading && (emptyState || noResultsState) ? (
              ...
              <TableBody
                ...
                getShiftAmount={getShiftAmount}
                isInlineDragMode={isInlineDragMode}
                draggedColumnKey={dragState.draggedKey}
              />
            )}
          </div>
        </div>
...
// Re-export filter system from V1 (compatible with V2)
export type {
  FilterCategory,
  FilterConfig,
  FilterOption,
...
export { DEFAULT_DATE_PRESETS, createSelectFilter, createDateFilter, createRangeFilter } from './filter-types'

export { useTableFilters, type UseTableFiltersProps, type UseTableFiltersReturn } from './hooks/use-table-filters'

export { FilterToolbar } from './components/filter-toolbar'
export { FilterDropdown } from './components/filter-dropdown'

// Re-export CSV export hook (compatible with V2)
export { useExportCsvSticky, type CsvExportableData } from './hooks/use-export-csv-sticky'
