...
exports.buildChipClassFromConfig = void 0;
/**
 ...
 */
function buildChipClassFromConfig(config) {
    const classes = [];
...
exports.buildChipClassFromConfig = buildChipClassFromConfig;
//# sourceMappingURL=build-chip-class.js.map