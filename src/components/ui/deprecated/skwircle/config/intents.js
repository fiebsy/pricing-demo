...
exports.getInputStateConfig = exports.INPUT_STATE_CONFIGS = exports.getIntentConfig = exports.VARIANT_INTENT_OVERRIDES = exports.INTENT_CONFIGS = void 0;
/**
 * Base intent color configurations.
 */
exports.INTENT_CONFIGS = {
    default: {
 ...
 */
exports.VARIANT_INTENT_OVERRIDES = {
 ...
 */
const getIntentConfig = (variant, intent) => {
    const base = exports.INTENT_CONFIGS[intent];
    const override = exports.VARIANT_INTENT_OVERRIDES[variant]?.[intent];
    if (override) {
        return { ...base, ...override };
    }
    return base;
};
exports.getIntentConfig = getIntentConfig;
/**
 * Input state configurations for focused/error/disabled states.
 */
exports.INPUT_STATE_CONFIGS = {
    default: {
 ...
 */
const getInputStateConfig = (state) => {
    return exports.INPUT_STATE_CONFIGS[state];
};
exports.getInputStateConfig = getInputStateConfig;
