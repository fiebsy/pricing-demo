...
exports.getRoundnessConfig = exports.ROUNDNESS_CONFIGS = void 0;
/**
 ...
 */
const getRoundnessConfig = (roundness) => {
    return exports.ROUNDNESS_CONFIGS[roundness];
};
exports.getRoundnessConfig = getRoundnessConfig;
