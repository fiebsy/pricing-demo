...
const SearchIconButton = ({ isExpanded, collapsedWidth, iconSize, iconStrokeWidth, iconOpacity, onClick, }) => {
    return (<button type="button" onClick={isExpanded ? undefined : onClick} className={(0, utils_1.cn)('absolute left-0 top-0 bottom-0', 'flex items-center justify-center', isExpanded
            ? 'text-primary'
