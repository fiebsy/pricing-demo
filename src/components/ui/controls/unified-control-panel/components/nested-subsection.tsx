...
export const GradientFadeOverlay = ({ config, className }: GradientFadeOverlayProps) => {
...
export const NestedInset = ({ depth, gradientFade, children, className }: NestedInsetProps) => {
  const depthStyles = {
