/**
 * Expandable Input - Trigger Types
 *
...
export interface TriggerConfig {
  ...
  /** Additional className for input area when in editing state (overrides inputAreaExpandedClassName) */
  inputAreaEditingClassName?: string
}
