 ...
 *
 * Consolidated types for the stacking navigation component.
...
/**
 * Combined stack context value (convenience hook combining all contexts).
 * New components should use individual context hooks for better performance.
 */
...
/**
 * Animation mode - single enum replacing scattered flags.
 */
