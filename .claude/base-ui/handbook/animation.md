...
For comprehensive Motion documentation, including gestures, hooks, and advanced patterns:

- [Motion Documentation](../../../motion-dev/init.md): Full Motion reference
- [Base UI Setup](../../../motion-dev/getting-started/base-ui-setup.md): Detailed integration guide
- [Animation Patterns](../../../motion-dev/advanced/patterns.md): Component animation recipes
